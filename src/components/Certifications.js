...
//                 imgName='AWS_Solutions.png' 
//                 desc='By AWS' 
//                 altdesc='The AWS Certified Solutions Architect - Associate certification helped me to gain a strong understanding of designing scalable, cost-effective, and secure cloud solutions using AWS services. I learned how to choose the right services for compute, storage, and networking in real world scenarios. 
//                 The certification also deepened my knowledge of best practices for high availability, fault tolerance, and performance optimization. Overall, it strengthened my ability to make informed architectural decisions and build reliable solutions in the AWS ecosystem.'
//                 link='https://cp.certmetrics.com/amazon/en/public/verify/credential/bfd85f6fb0224d1c986031da1cf5db43'
//             />
//             {/* <Certificate className='certificate' title='AWS Cloud Foundations' imgName='aws.png' desc='By AWS Academy' link='https://www.credly.com/badges/3e00fb4b-c9ef-4ccd-abf7-74389976caec/public_url' altdesc='This 10 module course along with guided labs helped me to gain knowledge in AWS Cloud Foundations and Security.' /> */}
...
export default function Certifications() {
  ...
  const certificates = [
    ...
    },
    {
      ...
      imgName: 'cloud-computing-core.png',
      desc: 'By IBM',
      link: 'https://www.credly.com/badges/1e877fa8-ca65-4053-803c-bb04a95dc710/public_url',
      altdesc: 'This course helped me to understand the core concepts of Cloud Computing...'
    },
    {
      title: 'Microsoft Azure Fundamentals (DP-900)',
      imgName: 'dp-900.png',
      desc: 'By Microsoft',
      altdesc: 'I learned the core data concepts and how they are implemented using Microsoft Azure data services...'
    },
    {
      title: 'JavaScript Essentials 1',
      imgName: 'JSE.png',
      desc: 'By Cisco Network Academy',
      altdesc: `This Course has helped me to learn JavaScript from Scratch to Intermediate Level...`
    },
    {
      title: 'Programming Essentials in Python 1 & 2',
      imgName: 'PCAP.png',
      desc: 'By Cisco Network Academy',
      altdesc: 'This Course has helped me to learn Python from Scratch...'
    },
    {
      title: 'Java Coding Challenge',
      imgName: 'JavaChallenge.png',
      desc: 'By CSI Club',
      link: 'https://credsverse.com/credentials/cb813c5e-6b84-4011-90ae-30baa5410ff8',
      altdesc: 'Successfully completed **100 Days Of Java Challenge**...'
    },
    {
      title: 'Project Merit Certificate',
      imgName: 'ECS.png',
      desc: 'By VIT- University',
      altdesc: 'Our Project (Smart Visual Assistant) was ranked in the **Top 15 projects**...'
    },
    {
      title: 'Using Python to Access Web data',
      imgName: 'Coursera.png',
      desc: 'By Coursera',
      link: 'https://coursera.org/share/7bd46aaafdeec7afbabab8c78c69fb3f',
      altdesc: 'In this course, I learned how to use regular expressions to extract data...'
    },
    {
      title: 'Web Development',
      imgName: 'GFG-Certificate.png',
      desc: 'By Geeks For Geeks',
      link: 'https://media.geeksforgeeks.org/certificates/1678717527/ce8cc13c9529c472027244d18cde9f3b.pdf',
      altdesc: 'During the GeeksforGeeks 2-day bootcamp on Web Development...'
    },
    {
      title: 'Code Battle',
      imgName: 'Code Battle.jpg',
      desc: 'By NGC Cloud Club',
      altdesc: 'Participated in a Coding Challenge...'
    },
    {
      title: 'Python Workshop',
      imgName: 'VIT_Python.png',
      desc: 'By VIT-AP',
      altdesc: 'Participated in 2 day workshop...'
    },
    {
      title: 'Front End Web Development',
      imgName: 'Great_Learning.jpg',
      desc: 'By Great Learning',
      altdesc: 'This course by Great Learning had thought me the fundamentals...'
    }
  ];

  const visibleCerts = showAll ? certificates : certificates.slice(0, 6); // Show 6 initially

  return (
    <div className="container certbox-m">
      <center>
        <h3 className="heading" style={{ paddingTop: '3px' }}>Certifications and Badges</h3>
      </center><br />
      <div className='container cont'>
        {visibleCerts.map((cert, index) => (
          <Certificate key={index} 
          data-aos="fade-up"
          data-aos-delay={index * 100} // optional staggered effec
          className='certificate' {...cert} />
        ))}
      </div>
